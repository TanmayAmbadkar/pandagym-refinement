...
from panda_gym_test.envs.core import RobotTaskEnv
from panda_gym_test.envs.robots.panda import Panda
from panda_gym_test.envs.tasks.flip import Flip
from panda_gym_test.envs.tasks.pick_and_place import PickAndPlace
from panda_gym_test.envs.tasks.push import Push
from panda_gym_test.envs.tasks.reach import Reach
from panda_gym_test.envs.tasks.slide import Slide
from panda_gym_test.envs.tasks.stack import Stack
from panda_gym_test.pybullet import PyBullet
...
class PandaReachEnv(RobotTaskEnv):
    ...
    def __init__(
        ...
        sim = PyBullet(render_mode=render_mode, renderer=renderer)
        robot = Panda(sim, block_gripper=True, base_position=np.array([-0.4, 0.0, 0.0]), control_type=control_type)
