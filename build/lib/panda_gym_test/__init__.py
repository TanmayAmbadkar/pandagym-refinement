...
for reward_type in ["sparse", "dense"]:
    for control_type in ["ee", "joints"]:
        ...
        register(
            ...
            entry_point="panda_gym_test.envs:PandaReachEnv",
            kwargs=kwargs,
        ...
        register(
            ...
            entry_point="panda_gym_test.envs:PandaPushEnv",
            kwargs=kwargs,
            max_episode_steps=50,
        )
        ...
        register(
            ...
            entry_point="panda_gym_test.envs:PandaSlideEnv",
            kwargs=kwargs,
            max_episode_steps=50,
        )
        ...
        register(
            ...
            entry_point="panda_gym_test.envs:PandaPickAndPlaceEnv",
            kwargs=kwargs,
            max_episode_steps=50,
        )
        ...
        register(
            ...
            entry_point="panda_gym_test.envs:PandaStackEnv",
            kwargs=kwargs,
        ...
        register(
            ...
            entry_point="panda_gym_test.envs:PandaFlipEnv",
            kwargs=kwargs,
            max_episode_steps=50,
        )
